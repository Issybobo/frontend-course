...
function EditEmployee(props) {
  ...
  <div className="md:flex md:items-center mb-6">
    ...
    <div className="md:w-2/3">
      <input className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="name" type="text" value={role} 
       onChange={(e) => {
        ...
        <button form = "editmodal" className='bg-slate-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded' onClick={handleClose}>Close</button>
          ...
          <button form = "editmodal" className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded'>Add</button>
